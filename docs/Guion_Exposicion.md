...
- **Administrador**: "El sistema se basa en tres niveles de acceso. El Admin se encarga de la configuración inicial, gestión de altas, bajas y control de permisos, utilizando interfaces optimizadas con listados paginados."
- **Dirección (El Corazón del Control)**:
  - "El director tiene una visión global del cuadrante y puede consultar los turnos de cualquier profesional filtrando por mes."
  - "Puede asignar turnos de forma masiva y modificar incidencias, con una previsualización dinámica que se actualiza en tiempo real sin recargar la página."
...
- **Real-Time**: "Mediante técnicas de _polling_ dinámico, las notificaciones de cambios y el contador de usuarios online se actualizan sin necesidad de refrescar la página, mejorando la interactividad."
...
- **Seguridad y Privacidad**: "Como medida extra de seguridad de datos, los identificadores de sesión en memoria están encriptados mediante hashing irreversible (SHA-256), demostrando atención a los estándares de privacidad actuales."

## 6. Conclusión y Cierre (1 min)

- **Resumen**: "En definitiva, Proyecto Guardias es una herramienta que transforma un proceso administrativo caótico en un flujo de trabajo automatizado, seguro y estéticamente superior."
